      ...
      <div className="w-[95%] md:w-[50%] xl:w-[40%] 2xl:w-[35%] mx-auto border-2 border-white p-8 rounded glass_morphism shadow-md flex flex-col ">
        ...
        <div className="flex flex-col gap-y-4">
          ...
          <p className="text-white text-sm font-semibold text-start pt-4">
            ...
            <span>
              <Link className="text-[#ca217ebb] font-semibold" to="/signup">
                Sign Up
              </Link>
            </span>
          </p>
          ...
          <button
            ...
            type="submit"
            className="text-[#ca217ebb] border  rounded-2xl bg-white w-1/3 mx-auto p-2 text-sm font-bold hover:cursor-pointer hover:bg-[#ca217ebb] hover:text-white hover:border-none transition duration-300"
          >
          ...
          <div className="flex items-center mt-6 gap-x-1">
            ...
            <p className="text-xs font-light text-white">
              By signing in, you agree to the terms and conditions for
              freedmobot.
            </p>
          </div>
        </div>
