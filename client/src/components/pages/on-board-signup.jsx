      ...
      <div className="bg-transparent w-full mt-8">
        <div className="w-[95%] md:w-[50%] xl:w-[40%] 2xl:w-[35%] mx-auto border-2 border-white p-8 rounded glass_morphism shadow-md flex flex-col gap-y-6">
          <div className="text-center text-white">
            ...
            <Link
              to="/login"
              className="text-[#ca217ebb] hover:text-white mt-6 inline-block"
            >
              Return to Login
            </Link>
          </div>
    ...
    <div className="bg-transparent w-full mt-8">
      <div className="w-[95%] md:w-[50%] xl:w-[40%] 2xl:w-[35%] mx-auto border-2 border-white p-8 rounded glass_morphism shadow-md flex flex-col gap-y-3 ">
        ...
        <div className="w-full flex items-center justify-between gap-x-4">
          <button
            onClick={handleCreateAccountAsReferal}
            className={`p-2 py-1 text-center rounded-md basis-1/2 font-medium ${accountType == "Referal" ? "bg-green-500 text-white" : "bg-white/20 text-green-500"}`}
          >
            Sign Up By Referal
          </button>
          <button
            onClick={handleCreateAsIndividual}
            className={`p-2 py-1  text-center rounded-md basis-1/2 font-medium ${accountType == "Individual" ? "text-white bg-green-500" : "bg-white/20 text-green-500"}`}
          >
        ...
        <div className="flex flex-col gap-y-3">
          ...
          <p className="text-white text-sm font-semibold text-start pt-4">
            ...
            <span>
              <Link className="text-[#ca217ebb] font-semibold" to="/login">
                Log In
              </Link>
            </span>
          </p>
