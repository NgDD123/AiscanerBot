...
const EditBlogModal = () => {
    ...
    const handleEditBlog = async (e) => {
        ...
        axios
            .patch(process.env.NODE_ENV === "production" ?
                `https://freedombot.online/blogs/update-blog/${blogId}` : `http://localhost:8001/blogs/update-blog/${blogId}`, data,
                {
                    headers: {
    ...
    return (
        ...
        >
            ...
            <div className="my-10 flex flex-row gap-10">
                <button onClick={handleCancel} className="glass_morphism text-white rounded-md  border-[2px] border-[rgba(67,67,67,0.09)] px-5 py-2">
                    Cancel
                </button>
                <div>
                    {!loading ? (
